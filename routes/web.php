    ...
    Route::middleware('admin')->group(function () {
        ...
        */
        ...
        Route::name('vehicle.ticket.')->prefix('ticket')->group(function(){
            ...
            Route::get('/search_date/{scope}', 'VehicleTicketController@searchDate')->name('search.date');
            Route::get('/search_vehicle/{scope}', 'VehicleTicketController@searchVehicle')->name('search.vehicle');
            Route::get('/search_trip/{scope}', 'VehicleTicketController@searchTrip')->name('search.trip');
        ...
        // banners
        Route::post('banners/delete', 'BannerController@destroy')->name('banners.delete');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('ticket-booking/payment/tabadul', 'Gateway\PaymentController@payTabadul')->name('deposit.pay.tabadul');
...
Route::get('/get-seat-price', 'SiteController@getSeatPrice')->name('ticket.get-seat-price');
Route::post('/ticket/book/{id}', 'SiteController@bookTicket')->name('ticket.book');
Route::post('/ticket/book_back/{id}', 'SiteController@bookTicketBack')->name('ticket.book.back');
