...
function tabadulPayment($payment)
{
    $data=[];
    $data['userName'] = "Abraj_api";
    $data['password']  = "Abraj@1234";
    $data['orderNumber'] = $payment->id;
    $data['amount'] = $payment->sub_total;
    $data['currancy'] = "368";
    $data['returnUrl'] = "https://google.com";
    $data['clientId'] = $payment->user_id;
    $data['description'] = "test";
    $data['language'] = "ku";
    $data['bindingId'] = "12";
    $data['email'] = "email@gmail.com";
    $data['Phone'] = "01063578278";
    $sending_data = http_build_query($data);
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://epgtest.tabadul.iq:9444/epg/rest/register.do",
