...
use App\Http\Requests\Api\Driver\Auth\{ RegisterRequest , ResendCodeRequest , SendCodeRequest ,VerifyRequest ,LoginRequest ,ForgetPasswordRequest ,ForgetPasswordCodeRequest ,ResetPasswordRequest,LogoutRequest };
...
class AuthController extends Controller
{
    ...
    public function register(RegisterRequest $request)
    {
        ...
        $user = User::create(collect($allRequest)->except(['password','mobile'])->toArray());
