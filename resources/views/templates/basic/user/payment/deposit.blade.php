    ...
    <div class="row justify-content-center gy-4">
        ...
        @endforeach
           <!-- <div class="col-lg-4 col-md-6 col-xl-3">
            <div class="card cmn--card card-deposit">
                <div class="card-header text-center">
                    <h5 class="title">Tabadul</h5>
                </div>
                <div class="card-body card-body-deposit">
                    <img src="{{asset('/assets/images/default.png')}}" class="card-img-top"  class="w-100">
                </div>
                <div class="card-footer pt-0 pb-4">
                    <a href="{{route('user.deposit.pay.tabadul')}}" data-booked_ticket="{{ $bookedTicket }}" class=" btn btn--base w-100 deposit" >
                        @lang('Pay Now')
                    </a>
                </div>
            </div>
