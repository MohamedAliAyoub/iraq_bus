...
@section('panel')
    <div class="row mb-none-30">
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.drivers.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('ApproveImage')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('PDF')</label>
                                    <input class="form-control" type="file" name="pdf" value="{{$user->pdf}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('Record')</label>
                                    <input class="form-control" type="file" name="record" value="{{$user->record}}">
                                </div>
                            </div>
                        </div>
                        @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="credit_limit"
                                               value="{{$user->pocket->credit_limit}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@lang('Information of') @lang('Driver')</h5>
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->first_id_card_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->last_id_card_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->first_residence_card_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->last_residence_card_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->first_license_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ $user->driverDetails->last_license_image_url }}" alt="" width="70" height="50" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@lang('Information of') @lang('Car')</h5>
                    <div class="row mt-3">
                        @foreach($user->driverCarImage as $image)
                        <div class="col-md-3">

                            <img src="{{ $image->image_url }}" alt="" width="100" height="70" class="img-fluid rounded">
                        </div>
                        @endforeach
                    </div>
                </div>
