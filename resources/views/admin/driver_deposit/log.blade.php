                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Driver')">
                                    <span class="font-weight-bold">{{ __($deposit->driver->fullname) }}</span>
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.users.detail', $deposit->driver_id) }}"><span>@</span>{{ __($deposit->driver->username) }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.driver_deposit.details', $deposit->id) }}"
...
@push('breadcrumb-plugins')
    @if(!request()->routeIs('admin.users.deposits') && !request()->routeIs('admin.users.deposits.method'))
        <form action="{{route('admin.driver_deposit.search', $scope ?? str_replace('admin.driver_deposit.', '', request()->route()->getName()))}}" method="GET" class="form-inline float-sm-right bg--white mb-2 ml-0 ml-xl-2 ml-lg-0">
        ...
        <form action="{{route('admin.driver_deposit.dateSearch',$scope ?? str_replace('admin.driver_deposit.', '', request()->route()->getName()))}}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append ">
        ...
        <div class="d-inline-block ml-2">
            <a href="{{ route('admin.driver_deposit.create') }}" class="btn btn--success"><i
