                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Enter Link')" name="link" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="publish_date" placeholder="@lang('Enter Publish Date')" required>
                            </div>
                        </div>
