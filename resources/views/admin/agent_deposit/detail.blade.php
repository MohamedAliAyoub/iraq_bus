            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <div class="p-3 bg--white">
                        <img src="{{ $deposit->gatewayCurrency()->methodImage() }}" alt="@lang('Profile Image')"
                ...
                <div class="card-body">
                    ...
                    @if($deposit->image)
                        @if($deposit->method_code >= 1000)
                                <div class="row mt-4">
                                    <div class="col-md-8">
                                        <h6>{{$deposit->user->username}} </h6>
                                        <h6>{{$deposit->mobile}} </h6>
                                        <img src="{{getImage('assets/images/agent/'.$deposit->image)}}"
                                             alt="@lang('Image')">
                                    </div>
                                </div>
    ...
    <div id="approveModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.agent_deposit.approve')}}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        <p>@lang('Are you sure to') <span class="font-weight-bold">@lang('approve')</span> <span
                            ...
                            <span class="font-weight-bold withdraw-user"></span>?</p>
                    </div>
    ...
    <div id="rejectModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.agent_deposit.reject')}}" method="POST">
                    @csrf
                    <input type="hidden" name="id">
                    <div class="modal-body">
