                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.agent_deposit.details', $deposit->id) }}"
...
@push('breadcrumb-plugins')
    @if(!request()->routeIs('admin.users.deposits') && !request()->routeIs('admin.users.deposits.method'))
        <form action="{{route('admin.agent_deposit.search', $scope ?? str_replace('admin.agent_deposit.', '', request()->route()->getName()))}}" method="GET" class="form-inline float-sm-right bg--white mb-2 ml-0 ml-xl-2 ml-lg-0">
        ...
        <form action="{{route('admin.deposit.dateSearch',$scope ?? str_replace('admin.agent_deposit.', '', request()->route()->getName()))}}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append ">
